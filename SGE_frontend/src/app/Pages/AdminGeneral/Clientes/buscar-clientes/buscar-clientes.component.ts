    ...
    if (this.telefono === true) {
      if (this.newTelefono == null || this.newTelefono == '') {
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: 'Si desea agregar un nuevo teléfono debe de llenar el campo',
          timer: 3000,
          iconColor: '#960010',
          confirmButtonColor: '#960010',
          customClass: {
    ...
    if (this.direccion === true) {
      ...
      if (
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: 'Debe de llenar el departamento',
          timer: 3000,
          iconColor: '#960010',
          confirmButtonColor: '#960010',
          customClass: {
      ...
      if (
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: 'Debe de llenar la direccion',
          timer: 3000,
          iconColor: '#960010',
          confirmButtonColor: '#960010',
          customClass: {
        ...
        Swal.fire({
          icon: 'success',
          title: 'Datos guardados',
          text: 'La nueva dirección ha sido agregada con éxito',
          timer: 3000,
          confirmButtonColor: '#960010',
          customClass: {
            popup: 'rounded-4',
    ...
    if (this.correo === true) {
      if (this.newCorreo == null || this.newCorreo == '') {
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: 'Si desea agregar un nuevo correo debe de llenar el campo',
          timer: 3000,
          iconColor: '#960010',
          confirmButtonColor: '#960010',
          customClass: {
        ...
        Swal.fire({
          icon: 'success',
          title: 'Datos guardados',
          text: 'El correo ha sido agregado con éxito',
          timer: 3000,
          confirmButtonColor: '#960010',
          customClass: {
            popup: 'rounded-4',
