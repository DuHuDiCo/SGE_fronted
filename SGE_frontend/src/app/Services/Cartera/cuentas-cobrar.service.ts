...
export class CuentasCobrarService {
  ...
  getCuentasCobrar(username:string, page:number, size:number, fechaCreacion:string){
    return this.http.get(`http://192.168.1.29:8021/api/v1/cuentas/cuentasCobrar?username=${username}&page=${page}&size=${size}&fechaCreacion=${fechaCreacion}`)
  }

  getCuentaByObligacion(numeroObligacion:string){
    return this.http.get(`http://192.168.1.29:8021/api/v1/cuentas/getCuentaCobrarByNumeroObligacion?numeroObligacion=${numeroObligacion}`)
  }
  ...
  getClasificacion(){
    return this.http.get(`http://192.168.1.29:8021/api/v1/nombreClasificacion/clasificaciones`)
  }

  getClasificacionById(id:number){
    return this.http.get(`http://192.168.1.29:8021/api/v1/nombreClasificacion/clasificacionById?id=${id}`)
  }

  saveClasificacion(clasificacion:any){
    return this.http.post(`http://192.168.1.29:8021/api/v1/nombreClasificacion/guardarClasificacion`, clasificacion)
  }

  updateClasificacion(clasificacion:clasificacion){
    return this.http.put(`http://192.168.1.29:8021/api/v1/clasificacion/updateClasificacion`, clasificacion)
  }

  // GESTIONES

  getGestiones(numeroObligacion:string){
    return this.http.get(`http://192.168.1.29:8021/api/v1/gestiones/getGestionByNumObligacion/${numeroObligacion}`)
  }

  saveGestion(gestion:Gestion){
    return this.http.post(`http://192.168.1.29:8021/api/v1/gestiones/saveOneGestion`, gestion)
  }

  getLastDatoAdicional(numeroObligacion:string){
    return this.http.get(`http://192.168.1.29:8021/api/v1/gestiones/getLastDatoAdicionalGestion/${numeroObligacion}`)
  }

  desactivateAcuerdoPago(id:number){
    return this.http.put(`http://192.168.1.29:8021/api/v1/gestiones/desactivateAcuerdoPago/${id}`, null)
  }

  reporte(data:any){
    return this.http.put(`http://192.168.1.29:8021/api/v1/gestiones/linkAndReporteAcuerdoToClient`, data)
  }

  // TIPO VENCIMIENTO
  saveTipoVencimiento(tipoVencimiento:TipoVencimiento){
    return this.http.post(`http://192.168.1.29:8021/api/v1/tiposVencimiento/guardarTipoVencimiento`, tipoVencimiento)
  }

  getTipoVencimiento(){
    return this.http.get(`http://192.168.1.29:8021/api/v1/tiposVencimiento/obtenerTodosTiposVencimientos`)
  }

  getTipoVencimientoById(id:number){
    return this.http.get(`http://192.168.1.29:8021/api/v1/tiposVencimiento/obtenerTiposVencimientoPorId/${id}`)
  }
  ...
  crearRecibo(pagoCuota:any){
    return this.http.post(`http://192.168.1.29:8021/api/v1/pagos/guardarPago`, pagoCuota)
  }
